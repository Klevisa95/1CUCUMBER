...
@CucumberOptions(
        ...
        tags = "@excel"  // pra run vec scenario tek @sprint4 jo scenario e tjera. Ne kte rast ose ali ose nafiseh. Nqs eshte @ali and @nafiseh then NO scenarios will be executed. Kur esht @emp do execute 2 scenarios sepse e kane te perbashket kte tag.
